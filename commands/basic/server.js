...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('info')
                .setDescription('Hiển thị thông tin chi tiết máy chủ với phân trang.')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('icon')
                .setDescription('Hiển thị biểu tượng máy chủ.')
        )
        .addSubcommand(subcommand =>
            subcommand
                .setName('banner')
                .setDescription('Hiển thị banner máy chủ.')
        ),
