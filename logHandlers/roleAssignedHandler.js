...
module.exports = async function guildMemberUpdateHandler(client) {
    client.on('guildMemberUpdate', async (oldMember, newMember) => {
        ...
        try {
            ...
            if (quarantineConfig?.quarantineEnabled) {
                ...
                if (quarantineRole) {
                    ...
                    if (
                        ...
                        await newMember.send('⚠ Vai trò Cách ly không thể bị xóa thủ công.').catch(() => { });
                    }
                }
            }
            ...
            console.error('⚠ Lỗi trong trình xử lý cập nhật thành viên:', err);
        }
    });
};
